...
public class MainController implements Initializable, Serializable{
    ...
    public static void cliente1() throws Exception{
        ...
        Atuador a = new Atuador("Atuador porta", "FECHADA", "PORTA", "SALA");
        Sensor s = new Sensor("sensor porta", "FECHADA", "PORTA", "SALA");
           
        Atuador a2 = new Atuador("Porta Quarto", "FECHADA", "PORTA", "QUARTO");
        Sensor s2 = new Sensor("sensor quarto", "FECHADA", "PORTA", "QUARTO");
        
        Atuador a3 = new Atuador("Atuador porta3", "FECHADA", "PORTA", "SALA2");
        Sensor s3 = new Sensor("sensor porta3", "FECHADA", "PORTA", "SALA2");
        
        sa.concatSA(s, a,   "adicionar");
        sa.concatSA(s2, a2, "adicionar");
        sa.concatSA(s3, a3, "adicionar");
                ...
                public void run() {
                    SwingUtilities.invokeLater(new Runnable() {
                        ...
                        public void run() {
                            try { 
                                sa.atualizarTabelas();
                                MainController.forceRefresh(sa.getListaSensor(), sa.getListaAtuador());                                
                                //System.out.println(sa.getListaSensor());       
